    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 6,
          name: 'Codeigniter',
          imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQcjwxTWPLW2IQTbr7Q1s5kucCBgWXJ3gND_rl-Ooo_jlMHPKKxe3KFCJw&s=10',
          status: 'Intermediate'
        },
        {
          id: 7,
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="https://files.catbox.moe/av066j.jpg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Kyluesky.
I'm an introverted person who prefers quiet moments over crowded places.
One of my biggest passions is watching anime—it's my favorite escape from reality.
For me, creating things, especially in the digital world, isn't just a task—it's an art that holds aesthetic value.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; My objective is to transform ideas into well-crafted, functional, and visually engaging results.
I prioritize both usability and aesthetics, ensuring each project is intuitive, impactful, and aligned with your vision.
By adding a thoughtful, personal touch, I aim to communicate your message clearly and creatively.
Should you be interested in collaborating, please don't hesitate to get in touch via the contact information provided.
          </p>
        </div>
