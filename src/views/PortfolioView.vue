      ...
      items: [
        {
          ...
          status: 'My personal Telegram bot, created to explore AI features, anime games, and automation tools like downloaders and social media integration.',
          tech: 'Node.js, Telegraf.js',
          github: 'null',
          demo: 'https://kyluesky.netlify.app/telegram'
        },
        {
          id: 2,
          name: 'Discord Bot',
          ...
          tech: 'Python',
          github: 'null',
          demo: 'https://discord.com/oauth2/authorize?client_id=1470527774937841664&scope=bot+applications.commands&permissions=8'
        },
        {
          id: 3,
          name: 'Bot Whatsapp',
          imageUrl: 'sistekdes',
          status: 'WhatsApp Bot for Information and Automation, built to assist users in managing tasks like data access, auto replies, media downloads, and various interactive features.',
          tech: 'Nodejs',
          github: 'null',
          demo: 'https://wa.me/6287859822633'
        },
        {
          id: 4,
          name: 'Roblox',
        ...
        },
        {
          ...
          name: 'Aespa',
          imageUrl: 'sp2se',
          status: 'Aespa, a K-pop girl group known for combining futuristic concepts and virtual avatars, redefining the boundaries between reality and the digital world.',
          tech: 'SM Entertainment, Virtual Concept',
          github: 'null',
          demo: 'https://youtube.com/@aespa?si=aRgAYsugpxyz7mh5'
        }
      ]
    };
  }
